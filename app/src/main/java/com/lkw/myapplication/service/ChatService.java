...
//                        roster.createEntry("zdf@10.0.154.195", "张", null);
    ...
    public void onCreate() {
        ...
        //连接服务器
        conn = new XMPPTCPConnection("10.0.154.55");
...
//
//                try {
//                    accountManager.createAccount("lkw", "123456");
//                } catch (Exception e) {
//                    e.printStackTrace();
//                }
//
...
//                //登录账号，上一个注册成功过的内容
//
//                //登录都是在连接打开之后，因此，登录方法在XMPPTCPConnection中
//                conn.login("lkw", "123456");
//
////                获取用户最基本的信息（检查是否登录成功）
////                返回已经登录的用户 JID(也就是发送消息时，收信人的格式)
//                String user = conn.getUser();
//
//                Log.d("ChatThread", "Login user:" + user);
//
//                //获取联系人列表
//                //getRoster()会自动从服务器获取当前登录用户的联系人列表，并返回Roster对象
...
//                //参数2.添加联系人时的 备注名词
//                //参数3，属于哪个组
//                roster.createEntry("lj@10.0.154.195", "张", null);
